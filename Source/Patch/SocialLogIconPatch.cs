...
/// <summary>
/// The direction indicator on a colonist's social tab.
///
...
public static class SocialLogIconPatch
{
    ...
    /// sentence actually addresses the recipient — the player's rule, and see
    ...
    /// <summary>
    /// "Chitchat" becomes "Outbound chitchat" on mouseover.
    ///
    ...
    /// than either on its own. One gate, not two agreeing ones — the player caught the first
